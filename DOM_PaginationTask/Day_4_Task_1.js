...
function pageButtons(pages){
    ...
    var div = createElemet('div','list-group list-group-horizontal');

    var pag_button_first = createElemet('button','btn btn-info list-group-item');
    pag_button_first.setAttribute('onclick',`index_pre(${state.page})`);
    pag_button_first.innerHTML='Previous';
    pag_button_first.style.color='orange';
    pag_button_first.style.fontWeight ="bolder";
    var pag_button_last = createElemet('button','btn btn-info list-group-item');
    pag_button_last.setAttribute('onclick',`index_next(${state.page},${pages})`);
    pag_button_last.innerHTML='Next';
    pag_button_last.style.color='orange';
    pag_button_last.style.fontWeight ="bolder";  
    

    for(var page=maxLeft;page<=maxRight;page++){
        var pag_button = createElemet('button','btn btn-sm btn-info list-group-item');
        pag_button.value = page;
        pag_button.style.color='orange';
    ...
    pagination.append(pag_button_first,div,pag_button_last);
}
...
function createElemet(element,eleClass='',eleId=' '){
    var element = document.createElement(element);
    element.setAttribute('class',eleClass);
    element.setAttribute('id',eleId);
    return element;
}
function creatHead(element,arr,elmClass='',elmid=''){
...
function createTable(arr){
    var table = createElemet('table','mt-3 table table-striped text-center','table_content');
    var thead = createElemet('thead','bg-dark');
